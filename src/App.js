  ...
  return (
    <>
      ...
      <div className="header-container">
        ...
        <a class="cart" onClick={basketModalHandler}><svg className="svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
